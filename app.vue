  ...
  <div class="bg-gray-100 min-h-screen">
      ...
      <div class="container mx-auto">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-lg mt-2 font-bold">Flutter | Java | Spring Boot | Nuxt.js</p>
          </div>
        </div>
      </div>
    </header>
    ...
    <section class="bg-white py-10">
      <div class="container mx-auto">
        ...
        <div class="text-center mt-4">
          <h3 class="text-xl font-semibold">Kak Elay</h3>
          <p class="text-gray-700">Flutter | Java | Spring Boot | Nuxt.js</p>
          <p class="text-gray-700">"It's going to be hard, but hard doesn't mean impossible."</p>

          <div class="flex justify-center mt-4">
            <div class="mx-2 flex flex-col items-center">
              <a href="https://www.facebook.com/profile.php?id=100058188477258&sk=photos" target="_blank">
                <img src="https://www.facebook.com/images/fb_icon_325x325.png" alt="Facebook" class="w-10 h-10">
              </a>
              <p class="text-lg mt-1 font-bold">Facebook</p>
            </div>
            <div class="mx-20 flex flex-col items-center">
              <a href="https://www.youtube.com/channel/UCpNVpH6jDFAKYeyy0j_Z7NQ" target="_blank">
                <img src="https://upload.wikimedia.org/wikipedia/commons/e/ef/Youtube_logo.png?20220706172052"
                  alt="YouTube" class="w-12 h-10">
              </a>
              <p class="text-lg mt-1 font-bold">YouTube</p>
            </div>
            <div class="mx-2 flex flex-col items-center">
              <a href="https://github.com/kakelay" target="_blank">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/2048px-Octicons-mark-github.svg.png"
                  alt="GitHub" class="w-10 h-10">
              </a>
              <p class="text-lg mt-1 font-bold">GitHub</p>
            </div>
    ...
    <section class="  font-bold mb- text-center">
      <div class="container mx-auto ">
        ...
        <p class="text-gray-700 font-bold mb-4" align="left">
          Education: Studying at NORTON University
        </p>
        <p class="text-gray-700 font-bold mb-4" align="left">
...
export default {
  ...
  methods: {
    zoomIn() {
      ...
      iframe.contentWindow.postMessage('{"event":"command","func":"zoomIn","args":[]}', '*');
    },
    zoomOut() {
      const iframe = this.$refs.mapIframe;
      iframe.contentWindow.postMessage('{"event":"command","func":"zoomOut","args":[]}', '*');
    }
  },
  ...
  methods: {
    initMap() {
      // Initialize the map and add any additional functionality here
      // You can also add code to center the map to your location
    },
...
<style scoped>
.bg-image {
  background-image: url('https://www.trio.dev/hubfs/Imported_Blog_Media/types%20of%20software%20development.webp');
...
.about-section {
  background-color: #6b636325;
  /* Replace with the desired background color */
  padding: 20px;
  /* Add some padding to create space between content and background */
}
